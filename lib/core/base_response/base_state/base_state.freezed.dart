...
mixin _$BaseState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(BaseErrorResponse failure) error,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(BaseErrorResponse failure)? error,
...
abstract class _$$BaseErrorImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({BaseErrorResponse failure});

  $BaseErrorResponseCopyWith<$Res> get failure;
}
...
class __$$BaseErrorImplCopyWithImpl<T, $Res>
  ...
  @pragma('vm:prefer-inline')
  $BaseErrorResponseCopyWith<$Res> get failure {
    return $BaseErrorResponseCopyWith<$Res>(_value.failure, (value) {
...
class _$BaseErrorImpl<T> implements BaseError<T> {
  ...
  @override
  final BaseErrorResponse failure;
...
abstract class BaseError<T> implements BaseState<T> {
  const factory BaseError(final BaseErrorResponse failure) = _$BaseErrorImpl<T>;

  BaseErrorResponse get failure;
  @JsonKey(ignore: true)
  _$$BaseErrorImplCopyWith<T, _$BaseErrorImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
